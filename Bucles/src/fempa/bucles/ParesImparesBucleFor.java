...
public class ParesImparesBucleFor {
	...
	public static void main(String[] args) {
		...
		// Pide un número al usuario hasta que introduzca uno mayor que 2:
		boolean numeroCorrecto = false;
		do {
			System.out.print("¿Cuántos números quieres introducir? ");
			cant = teclado.nextInt();
			if (cant < 3) {
				System.out.println("Debes introducir un número mayor que 2.");
			} else {
				numeroCorrecto = true;
			}
		...
		// Pode los n números introducidos por el usuario:
