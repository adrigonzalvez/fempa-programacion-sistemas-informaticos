...
public class Cadenas {
	...
	public static void main(String[] args) {
		...
		cadena = " El día de mañana. ";
		System.out.println("Longitud cad: " + cadena.length());
		String cad1 = cadena.trim();
		System.out.println("Longitud cad1: " + cad1.length());
		
		// Un sólo caracter
		System.out.println(cad1.charAt(0) + cad1.charAt(3) + cad1.charAt(7) + cad1.charAt(10));	// 378 vuelve a sumar los códigos ASCII de los caracteres
		...
		// Búsqueda, nos devuelve la posición (int)
		cadena = "El día de mañana.";
		int pos = cadena.indexOf('a');
		System.out.println("a está en: " + pos);
